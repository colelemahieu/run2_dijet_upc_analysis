...
// This code unfolds a 2D histogram, phi vs rapidity, for the higher QT bin
...
void unfold_2D_rap1_data_syst()
{
 ...
 TH2D *h2_phi12_rap_qt1_meas = (TH2D*)fileR4->Get("h2_phi12_rap_qt1");
 TH2D* h2_meas_orig = (TH2D*)h2_phi12_rap_qt1_meas->Clone("h2_meas_orig"); 
 TH1D *h_z_rap_qt1_meas = (TH1D*)fileR4->Get("h_measZ_rap1");
 TH2D *h2_phi12_rap_qt1_gen = new TH2D("h2_phi12_rap_qt1_gen","h2_phi12_rap_qt1_gen",nBins,rapidityBins, 12,-TMath::Pi(),TMath::Pi());
 TH2D *h2_phi12_rap_qt1_genMatch = new TH2D("h2_phi12_rap_qt1_genMatch","h2_phi12_rap_qt1_genMatch",nBins,rapidityBins, 12,-TMath::Pi(),TMath::Pi());
 TH2D *h2_phi12_rap_qt1_reco = new TH2D("h2_phi12_rap_qt1_reco","h2_phi12_rap_qt1_reco",nBins,rapidityBins, 12,-TMath::Pi(),TMath::Pi());
 TH2D *h2_phi12_rap_qt1_recoMatch = new TH2D("h2_phi12_rap_qt1_recoMatch","h2_phi12_rap_qt1_recoMatch",nBins,rapidityBins, 12,-TMath::Pi(),TMath::Pi());
 TH2D *h2_phi12_rap_qt1_miss = new TH2D("h2_phi12_rap_qt1_miss","h2_phi12_rap_qt1_miss",nBins,rapidityBins, 12,-TMath::Pi(),TMath::Pi());
 TH2D *h2_phi12_rap_qt1_fake = new TH2D("h2_phi12_rap_qt1_fake","h2_phi12_rap_qt1_fake",nBins,rapidityBins, 12,-TMath::Pi(),TMath::Pi());
 // forward folding
 ...
 //for (int i=floor(jetEnt/2); i<jetEnt; i++)
    {
      ...
      if (passGenCuts==1)
      {
       h2_phi12_rap_qt1_gen->Fill(rapPrime_gen, angle12_gen);
      }
      if (passRecoCuts==1)
      {
       h2_phi12_rap_qt1_reco->Fill(rapPrime,angle12);
      }
	...
	response_phi12_rap.Fill(rapPrime, angle12, rapPrime_gen, angle12_gen);
        ...
        h2_phi12_rap_qt1_genMatch->Fill(rapPrime_gen, angle12_gen);
	h2_phi12_rap_qt1_recoMatch->Fill(rapPrime, angle12);
	...
	h2_phi12_rap_qt1_miss->Fill(rapPrime_gen, angle12_gen);
      }
      if (fakeEvt==1)
      {
	...
	h2_phi12_rap_qt1_fake->Fill(rapPrime, angle12);
...
TH2D* h2_purity_factor = (TH2D*)h2_phi12_rap_qt1_recoMatch->Clone("h2_purity_factor");
TH2D* h2_purity_denom = (TH2D*)h2_phi12_rap_qt1_recoMatch->Clone("h2_purity_denom");
h2_purity_denom->Sumw2();
h2_purity_denom->Add(h2_phi12_rap_qt1_fake);
h2_purity_factor->Divide(h2_phi12_rap_qt1_recoMatch,h2_purity_denom,1,1,"B");

// purity correction (for fakes)
h2_phi12_rap_qt1_meas->Sumw2();
h2_phi12_rap_qt1_meas->Multiply(h2_purity_factor);

// make acceptance histogram
TH2D* h2_acceptance_factor = (TH2D*)h2_phi12_rap_qt1_recoMatch->Clone("h2_acceptance_factor");
TH2D* h2_denom = (TH2D*)h2_phi12_rap_qt1_recoMatch->Clone("h2_denom");
h2_denom->Sumw2();
h2_denom->Add(h2_phi12_rap_qt1_miss);
h2_acceptance_factor->Divide(h2_phi12_rap_qt1_recoMatch,h2_denom,1,1,"B");

// unfolding
RooUnfoldBayes unfold_bayes_phi12_rap_qt1(&response_phi12_rap, h2_phi12_rap_qt1_meas, 2);
auto* hReco_bayes_phi12_rap_qt1 = unfold_bayes_phi12_rap_qt1.Hunfold();

// Acceptance Correction
TH2D* h2_phi12_rap_qt1_acceptance = (TH2D*)unfold_bayes_phi12_rap_qt1.Clone("h2_phi12_QT5_acceptance");
h2_phi12_rap_qt1_acceptance->Divide(h2_acceptance_factor);

// z business
TH1D* h_measZ_orig = (TH1D*)h_z_rap_qt1_meas->Clone("h_measZ_orig");
...
h_z_rap_qt1_meas->Multiply(h_purity_Z);
RooUnfoldBayes unfold_bayes_z(&response_z, h_z_rap_qt1_meas, 2);
...
if (noSystematics)
{
  TFile newfile("unfolded2D_phiRapidity_data_rap1.root","recreate"); 
  response_phi12_rap.Write("responseObject");
  response_z.Write("responseObject_z");
  response_phi12_rap.Hresponse()->Write("response_hist");
  h_z_rap_qt1_meas->Write("h_measZ");
  h_recoMatchZ->Write();
  hReco_bayes_phi12_rap_qt1->Write("h2_unf");
  hUnf_bayes_z->Write("h_unf_z");
  h2_phi12_rap_qt1_meas->Write("h2_meas");
  h2_meas_orig->Write("h2_meas_orig");
  h2_phi12_rap_qt1_gen->Write("h2_gen");
  h2_phi12_rap_qt1_genMatch->Write("h2_genMatch");
  h2_phi12_rap_qt1_reco->Write("h2_reco");
  h2_phi12_rap_qt1_recoMatch->Write("h2_recoMatch");
  h2_phi12_rap_qt1_fake->Write("h2_fake");
  h2_phi12_rap_qt1_miss->Write("h2_miss");
  h2_phi12_rap_qt1_acceptance->Write("h2_phi12_rap_qt0_acceptance");
...
if (jesSystematicsUp)
{
  TFile newfile("unfolded2D_phiRapidity_JESup_rap1.root","recreate");
  response_phi12_rap.Write("responseObject");
  response_z.Write("responseObject_z");
  response_phi12_rap.Hresponse()->Write("response_hist");
  h_z_rap_qt1_meas->Write("h_measZ");
  ...
  h2_phi12_rap_qt1_genMatch->Write("h2_genMatch");
  h2_phi12_rap_qt1_reco->Write("h2_reco");
  h2_phi12_rap_qt1_recoMatch->Write();
  h2_phi12_rap_qt1_fake->Write();
  h2_phi12_rap_qt1_miss->Write("h2_miss");
  h2_phi12_rap_qt1_meas->Write("h2_meas");
  newfile.Write();
  newfile.Close();
...
if (jecSystematicsNom)
{
  TFile newfile("unfolded2D_phiRapidity_JECnom_rap1.root","recreate");
  response_phi12_rap.Write("responseObject");
  response_z.Write("responseObject_z");
  response_phi12_rap.Hresponse()->Write("response_hist");
  h_z_rap_qt1_meas->Write("h_measZ");
...
if (jesSystematicsDown)
{
  TFile newfile("unfolded2D_phiRapidity_JESdown_rap1.root","recreate");
  response_phi12_rap.Write("responseObject");
  response_z.Write("responseObject_z");
  response_phi12_rap.Hresponse()->Write("response_hist");
  h_z_rap_qt1_meas->Write("h_measZ");
...
if (jerSystematicsUp)
{
  TFile newfile("unfolded2D_phiRapidity_JERup_rap1.root","recreate");
  response_phi12_rap.Write("responseObject");
  response_z.Write("responseObject_z");
  response_phi12_rap.Hresponse()->Write("response_hist");
  h_z_rap_qt1_meas->Write("h_measZ");
...
if (jerSystematicsDown)
{
  TFile newfile("unfolded2D_phiRapidity_JERdown_rap1.root","recreate");
  response_phi12_rap.Write("responseObject");
  response_z.Write("responseObject_z");
  response_phi12_rap.Hresponse()->Write("response_hist");
  h_z_rap_qt1_meas->Write("h_measZ");
...
if (jarSystematics)
{
  TFile newfile("unfolded2D_phiRapidity_JAR_rap1.root","recreate");
  response_phi12_rap.Write("responseObject");
  response_z.Write("responseObject_z");
  response_phi12_rap.Hresponse()->Write("response_hist");
  h_z_rap_qt1_meas->Write("h_measZ");
...
#ifndef __CINT__
int main () { unfold_2D_rap1_data_syst(); return 0; }  // Main program when run stand-alone
#endif
