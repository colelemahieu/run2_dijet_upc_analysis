...
void pad3(TH1F *h_JES_R2, TH1F *h_JER_R2, TH1F *h_JAR_R2, TH1F *h_LSR_R2, TH1F *h_Prior_R2, TH1F *h_trkGap_R2, TH1F *h_HF_R2, TH1F *h_ITER_R2, TH1F *h_total_R2, TH1F *h_JES_R4, TH1F *h_JER_R4, TH1F *h_JAR_R4, TH1F *h_LSR_R4, TH1F *h_Prior_R4, TH1F *h_trkGap_R4, TH1F *h_HF_R4, TH1F *h_ITER_R4, TH1F *h_total_R4, TH1F *h_JES_R6, TH1F *h_JER_R6, TH1F *h_JAR_R6, TH1F *h_LSR_R6, TH1F *h_Prior_R6, TH1F *h_trkGap_R6, TH1F *h_HF_R6, TH1F *h_ITER_R6, TH1F *h_total_R6, const char *titleX, const char *titleY, const char *name, float yMinimum=0, float yMaximum=333, float x1=0.60, float x2=0.80, float y1=0.65, float y2=0.80)
{
  ...
  drawLegendStr9(h_JES_R2, h_JER_R2, h_JAR_R2, h_LSR_R2, h_Prior_R2, h_trkGap_R2, h_HF_R2, h_ITER_R2, h_total_R2, 0.2, 0.55, 0.5, 0.85, "JES", "JER", "JAR", "LSR", "Prior", "Tracker Gap", "HF", "Iterations", "Total");
  ...
  drawText(0.675, 0.915, "PbPb: #sqrt{s_{_{NN}}} = 5.02 TeV (2018)", kBlack, 28);
...
void drawSystematics2()
{
  // input files
  TFile *fileR2 = new TFile("Files/systematic_hists_r2.root");
  TFile *fileR4 = new TFile("Files/systematic_hists_r4.root");
  TFile *fileR6 = new TFile("Files/systematic_hists_r6.root");
  ...
  pad3(h_JES_R2, h_JER_R2, h_JAR_R2, h_LSR_R2, h_Prior_R2, h_trkGap_R2, h_HF_R2, h_ITER_R2, h_total_R2, h_JES_R4, h_JER_R4, h_JAR_R4, h_LSR_R4, h_Prior_R4, h_trkGap_R4, h_HF_R4, h_ITER_R4, h_total_R4, h_JES_R6, h_JER_R6, h_JAR_R6, h_LSR_R6, h_Prior_R6, h_trkGap_R6, h_HF_R6, h_ITER_R6, h_total_R6, "                         Q_{T} [GeV]", "Contribution to systematics (10^{-2})", "Pics/systematics_3panel_v2.pdf", 0 ,16);
  // plot
