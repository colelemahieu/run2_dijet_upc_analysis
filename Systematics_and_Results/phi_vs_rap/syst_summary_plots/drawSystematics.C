...
void drawSystematics(string JES_string, string JER_string, string JAR_string, string LSR_string, string Prior_string, string trkGap_string, string HF_string, string ITER_string, string outputName)
{
  ...
  TH1F *h_JES = new TH1F("h_JES","h_JES",nBins, rapidityBins);
  TH1F *h_JER = new TH1F("h_JER","h_JER",nBins, rapidityBins);
  TH1F *h_JAR = new TH1F("h_JAR","h_JAR",nBins, rapidityBins);
  TH1F *h_LSR = new TH1F("h_LSR","h_LSR",nBins, rapidityBins);
  TH1F *h_Prior = new TH1F("h_prior","h_prior",nBins, rapidityBins);
  TH1F *h_trkGap = new TH1F("h_trkGap","h_trkGap",nBins, rapidityBins);
  TH1F *h_HF = new TH1F("h_HF","h_HF",nBins, rapidityBins);
  TH1F *h_ITER = new TH1F("h_ITER","h_ITER",nBins, rapidityBins);
  TH1F *h_total = new TH1F("h_total","h_total",nBins, rapidityBins);
  ...
  h_JES->SetStats(0);
  h_JES->GetYaxis()->SetRangeUser(0,8);
  h_JES->SetTitle(";y'; <cos(2#phi)> difference per bin (10^{-2});");
  h_JES->Draw("hist");
