// grab_v2_from_2D_orig_rap0.C
// This script takes in a 2D hist (phi vs rapidity) named h2_meas_orig and uses a fit to extract the v2 value from each bin in rapidity. The output is a 5-bin 1D histogram
...
void grab_v2_from_2D_orig_rap0(string file_string)
{
  // Read File
  ...
  TH2D *h2_phi12_rap_qt = (TH2D*)file->Get("h2_meas_orig");
