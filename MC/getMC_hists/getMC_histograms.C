...
// this code also applies final event selections to reco level Pythia photonuclear MC and writes histograms to a file
...
void getMC_histograms()
{
  bool thirdJetCut=true;
  
  // read reco MC data
  //TFile *file = new TFile("../pythiaReco_miniAODr2_newCuts.root");
  TFile *file = new TFile("../pythiaReco_miniAODr4_newCuts.root");
  //TFile *file = new TFile("../pythiaReco_miniAODr6_newCuts.root");
  ...
  TH1F *h_etaRes = new TH1F("h_etaRes","genEta - jetEta",10000,-1.5,1.5);
  TH1F *h_phiRes = new TH1F("h_phiRes","genPhi - jetPhi",10000,-1.5,1.5);
  ...
  TH1F *h_PhiRes = new TH1F("h_PhiRes","h_PhiRes",75,-3.15,3.15);
  ...
  TH1F *h_qtRes_x_1 = new TH1F("h_qtRes_x_1","h_qtRes_x_1",100,-20,20);
  TH1F *h_qtRes_x_2 = new TH1F("h_qtRes_x_2","h_qtRes_x_2",100,-20,20);
  TH1F *h_qtRes_x_3 = new TH1F("h_qtRes_x_3","h_qtRes_x_3",100,-20,20);
  TH1F *h_qtRes_x_4 = new TH1F("h_qtRes_x_4","h_qtRes_x_4",100,-20,20);
  TH1F *h_qtRes_x_5 = new TH1F("h_qtRes_x_5","h_qtRes_x_5",100,-20,20);
  TH1F *h_qtRes_y_1 = new TH1F("h_qtRes_y_1","h_qtRes_y_1",100,-20,20);
  TH1F *h_qtRes_y_2 = new TH1F("h_qtRes_y_2","h_qtRes_y_2",100,-20,20);
  TH1F *h_qtRes_y_3 = new TH1F("h_qtRes_y_3","h_qtRes_y_3",100,-20,20);
  TH1F *h_qtRes_y_4 = new TH1F("h_qtRes_y_4","h_qtRes_y_4",100,-20,20);
  TH1F *h_qtRes_y_5 = new TH1F("h_qtRes_y_5","h_qtRes_y_5",100,-20,20);
  ...
  for (int i=0; i<jetEnt; i++)
	...
	h_QTPT_phiRes->Fill(angle12_gen-angle12);
      ...
      h_PhiRes->Fill(angle12_gen - angle12);   
      h2_genPhi_recoPhi->Fill(angle12_gen, angle12);
      h_qtRes->Fill(QT_norm_gen-QT_norm);
      h_qtRes_x->Fill(Q_T_gen.X()-Q_T.X());
      if (QT_norm>0 && QT_norm<8) h_qtRes_x_1->Fill(Q_T_gen.X()-Q_T.X());
      if (QT_norm>8 && QT_norm<16) h_qtRes_x_2->Fill(Q_T_gen.X()-Q_T.X());
      if (QT_norm>16 && QT_norm<24) h_qtRes_x_3->Fill(Q_T_gen.X()-Q_T.X());
      if (QT_norm>24 && QT_norm<32) h_qtRes_x_4->Fill(Q_T_gen.X()-Q_T.X());
      if (QT_norm>32 && QT_norm<40) h_qtRes_x_5->Fill(Q_T_gen.X()-Q_T.X());
      h_qtRes_y->Fill(Q_T_gen.Y()-Q_T.Y());
      if (QT_norm>0 && QT_norm<8) h_qtRes_y_1->Fill(Q_T_gen.Y()-Q_T.Y());
      if (QT_norm>8 && QT_norm<16) h_qtRes_y_2->Fill(Q_T_gen.Y()-Q_T.Y());
      if (QT_norm>16 && QT_norm<24) h_qtRes_y_3->Fill(Q_T_gen.Y()-Q_T.Y());
      if (QT_norm>24 && QT_norm<32) h_qtRes_y_4->Fill(Q_T_gen.Y()-Q_T.Y());
      if (QT_norm>32 && QT_norm<40) h_qtRes_y_5->Fill(Q_T_gen.Y()-Q_T.Y());
      ...
      h2_cosQTPT_QT_mpi->Fill(QT_norm, cos(2*angle12));
      ...
      //while (fillAngleDiff > 2*(TMath::Pi())) fillAngleDiff = fillAngleDiff - 2*TMath::Pi();
