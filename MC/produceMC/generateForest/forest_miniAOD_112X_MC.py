# this produces MC Forest files
# run with CMSSW_11_2_1_patch2
...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring(
        ...
        #'file:/eos/cms/store/group/phys_heavyions/clemahie/RECO/pythiaRECO/MinBias_PbPb_5p36TeV_Hydjet_RECO_Run2/241205_184117/0000/stepAODMINIAOD_392.root'
        #'file:/eos/cms/store/group/phys_heavyions/clemahie/RECO/pythiaRECO/stepAODMINIAOD_1.root'
        #'file:/eos/cms/store/group/phys_heavyions/clemahie/RECO/pythiaRECO/stepAODMINIAOD_2.root'
        #'file:/afs/cern.ch/user/c/clemahie/MC_MINIAOD_Forest/CMSSW_11_2_1_patch2/src/stepAODMINIAOD_merge.root'

        # test single files
        #'file:/afs/cern.ch/user/c/clemahie/MC_MINIAOD_Forest/CMSSW_11_2_1_patch2/src/HeavyIonsAnalysis/Configuration/test/stepAODMINIAOD.root'
        #'file:/eos/cms/store/group/phys_heavyions/clemahie/stepAODMINIAOD_100pt.root'
        #'file:/afs/cern.ch/user/c/clemahie/CMSSW_el8/CMSSW_12_5_0/src/test_out_aod.root'
